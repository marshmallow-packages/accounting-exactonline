...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        setAppStatus: function setAppStatus(status) {
            this.app_status = status;
        },
        goToExactOnlineForAuth: function goToExactOnlineForAuth() {
        ...
        disconnect: function disconnect() {
            ...
            this.setAppStatus('checking');
            var original_header = this.text.loading.header;
            var original_text = this.text.loading.text;

            this.text.loading.header = this.text.disconnect.header;
            this.text.loading.text = this.text.disconnect.text;
            Nova.request().get('/nova-vendor/exact-online/disconnect').then(function (response) {
                _this.showConnectButton();
                _this.text.loading.header = original_header;
                _this.text.loading.text = original_text;
                _this.$toasted.show(_this.text.disconnect.success, { type: "success" });
            }).catch(function (response) {
                _this.setAppStatus('connected');
                _this.text.loading.header = original_header;
                _this.text.loading.text = original_text;
            });
        },
        showConnectButton: function showConnectButton() {
            var _this2 = this;

            this.setAppStatus('show_auth');
            Nova.request().get('/nova-vendor/exact-online/authenticate').then(function (response) {
                _this2.auth_url = response.data.auth_url;
            });
        },
        getCurrentUser: function getCurrentUser(callback) {
            var _this3 = this;

            Nova.request().get('/nova-vendor/exact-online/me').then(function (response) {
                if (!response.data.success) {
                    _this3.showConnectButton();
                } else {
                    _this3.user = response.data.user;
                    _this3.visible_user_fields = response.data.visible_user_fields;
                    _this3.setAppStatus('connected');
                    if (callback) {
                        callback(_this3);
                    }
                }
    ...
    mounted: function mounted() {
        ...
        if (vue.$route.query.code) {
            ...
            Nova.request().get('/nova-vendor/exact-online/validate?code=' + vue.$route.query.code).then(function (response) {
                vue.getCurrentUser(function (vue) {
                    var query = Object.assign({}, vue.$route.query);
                    delete query.code;
                    vue.$router.replace({ query: query });
                    vue.$toasted.show(vue.text.connection_successfull_toaster, { type: "success" });
                });
            }).catch(function (response) {
                _this4.setAppStatus('show_auth');
                _this4.text.connect_button_text = _this4.text.connect_retry;
                _this4.showConnectButton();
            });
        } else {
            vue.getCurrentUser();
        }
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Exact Online")]),
      _vm._v(" "),
      _vm.app_status === "connected"
        ? _c(
            "div",
            ...
            [
              _c(
                ...
                {
                  staticClass:
                    "bg-success mb-6 flex flex-col items-center justify-center",
                ...
                [
                  _c("p", { staticClass: "text-white-50% text-lg" }, [
                    _vm._v(
                      "\n                " +
                        _vm._s(_vm.text.connection_successfull) +
                        "\n            "
                    )
                  ])
                ]
              ...
              _c(
                ...
                _vm._l(this.visible_user_fields, function(field) {
              ...
              _c(
                ...
                [
                  _vm._v(
                    "\n            " +
                      _vm._s(_vm.text.disconnect_button_text) +
                      "\n        "
                  )
                ]
              )
            ...
            [
              _c(
                ...
                [
                  _vm._v(
                    "\n            " +
                      _vm._s(_vm.text.connect_to_exact) +
                      "\n        "
                  )
                ]
              ),
              ...
              _c("p", { staticClass: "text-white-50% text-lg" }, [
                _c(
                  "a",
                  {
                    ...
                    attrs: { href: "#" },
                    on: { click: _vm.goToExactOnlineForAuth }
                  },
                  [
                    _vm._v(
                      "\n                " +
                        _vm._s(_vm.text.connect_button_text) +
                        "\n            "
                    )
                  ]
                )
                ...
                ? _c("p", { staticClass: "text-white-50% text-lg mt-6" }, [
                    _c(
                      ...
                      [
                        _vm._v(
                          "\n                " +
                            _vm._s(_vm.text.something_went_wrong) +
                            ' "' +
                            _vm._s(_vm.error) +
                            '"\n            '
                        )
            ...
            [
              ...
              _c(
                ...
                [
                  _vm._v(
                    "\n            " +
                      _vm._s(_vm.text.loading.header) +
                      "\n        "
                  )
                ]
              ),
