...
Nova.booting(function (Vue, router, store) {
  Vue.component('exact-online-card', __webpack_require__(17));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        var vue = this;
        Nova.request().get('/nova-vendor/exact-online/connected').then(function (response) {
            if (response.data.connected) {
                _this.card_status = 'loaded';
                _this.header = 'Verbonden';
                _this.text = 'Verbinding met Exact Online is goed';
                _this.isActive = true;
                _this.hasError = false;
            } else {
                _this.card_status = 'loaded';
                _this.header = 'Niet verbonden';
                _this.text = 'Er is geen verbinding met Exact Online';
...
var render = function() {
  ...
  return _c(
    "card",
    {
      staticClass: "exact-online-svg-card",
      class: { "bg-success": _vm.isActive, "bg-danger": _vm.hasError }
    },
    [
      _c(
        "svg",
        {
          staticClass: "exact-online-svg-card-icon",
        ...
        [
          _c("path", {
            attrs: {
              fill: "#E1141D",
              d:
                "M26.6,26.1h-8c-3.8,0-5.6-1.4-6.1-4.8h11.8v0h4.1v-1.2c0,0,0-0.1,0-0.1v-4.1c0,0,0-0.1,0-0.1v-1.2h-1.2\n        c0,0-0.1,0-0.1,0H12.5c0.5-3.5,2.2-5,6.1-5h12V2.8h-3.6v0h-9.2C8.5,2.8,5,7.5,5,17.8c0,10.3,3.6,15,12.9,15h11.6c0,0,0,0,0,0h1.3\n        v-6.8C30.8,26.1,26.6,26.1,26.6,26.1z"
            }
          })
        ]
      ),
      ...
      _c("div", { staticClass: "flex flex-col items-center justify-center" }, [
        _vm.card_status === "checking"
          ? _c("div", { staticClass: "px-3 py-3 mt-6" }, [
              _c(
                "svg",
                {
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm.card_status === "loaded"
          ? _c("div", { staticClass: "px-3 py-3" }, [
              _c("h1", { staticClass: "text-center text-white-50% mt-6" }, [
                _vm._v(_vm._s(_vm.header))
              ]),
              _vm._v(" "),
              _c("p", { staticClass: "text-white-50% text-center" }, [
                _vm._v("\n                " + _vm._s(_vm.text)),
                _c("br"),
                _vm._v(" "),
                _vm.hasError === true
